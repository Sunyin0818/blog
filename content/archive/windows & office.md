...
----                 -------------         ------ ----
-a---           2025/7/24     9:38           1257 configuration-Office365-x64.xml
-a---           2025/6/29    11:42        7349608 setup.exe
```
...
<Configuration>
  ...
  <Add OfficeClientEdition="64" SourcePath="D:\" Channel="Current">
...
```powershell
sudo ./setup.exe /configure '.\configuration-Office365-x64 - custom.xml'
```
